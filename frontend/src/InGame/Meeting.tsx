...
export default function Meeting(props: MeetingProps) {
    ...
    return (
        <div className="flex h-screen w-screen flex-col place-content-center justify-center p-5">
            <h1 className="text-4xl mx-auto mb-5">
                {
                    purpose === "Emergency" ? "Emergency Meeting" : "Body Reported"
                }
            </h1>
            <h2 className="text-xl mx-auto mb-5">Initiator: {initatingPlayer?.username}</h2>
            <h3 className="text-lg text-center">{currentPlayer?.username}</h3>
